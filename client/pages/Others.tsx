...
export default function Others() {
  ...
  const saveRoleChange = () => {
    if (changingRoleUserId && selectedRole) {
      ...
      console.log(
        `Changing user ${changingRoleUserId} role to ${selectedRole}`,
      );
  ...
  // User directory data (empty initially)
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Complete list of all employees with their positions
                      </p>
                    </div>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right space-y-2">
                              <div className="flex items-center space-x-2">
                                <Badge
                                  className={getLevelBadgeColor(user.level)}
                                >
                                  {user.level}
                                </Badge>
              ...
              <TabsContent value="departments" className="p-6">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Employees organized by department and positions
                    </p>
                  </div>
              ...
              <TabsContent value="analytics" className="p-6">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Statistics and insights about team structure
                    </p>
                  </div>
              ...
              <TabsContent value="settings" className="p-6">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Assign roles and page access permissions to users
                    </p>
                  </div>
                      ...
                      <div className="space-y-6">
                            ...
                            <div className="p-3 border rounded-lg bg-red-50">
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-sm text-red-700">
                                    Full access to all pages and system settings
                                  </p>
                                </div>
                              ...
                              <div className="mt-2">
                                <p className="text-xs text-red-600">
                                  Pages: Dashboard, Daily Tracker, Shift
                                  Handover, All Users Data, Others, User
                                  Management
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="p-3 border rounded-lg bg-blue-50">
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-sm text-blue-700">
                                    Access to management and reporting features
                                  </p>
                                </div>
                              ...
                              <div className="mt-2">
                                <p className="text-xs text-blue-600">
                                  Pages: Dashboard, Daily Tracker, Shift
                                  Handover, All Users Data, Others
                                </p>
                              </div>
                            </div>
                              ...
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-sm text-green-700">
                                    Access to production operations and
                                    monitoring
                                  </p>
                                </div>
                              ...
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-sm text-purple-700">
                                    Access to UAT testing and validation
                                    features
                                  </p>
                                </div>
                              ...
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-sm text-orange-700">
                                    Access to development and coding features
                                  </p>
                                </div>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mb-4">
                            Configure access permissions for each role and page
                          </p>
                          ...
                          <div className="overflow-x-auto">
                            <table className="w-full text-sm border rounded-lg">
                              ...
                              <tbody>
                                {Object.keys(pagePermissions).map(
                                  (role, index) => (
                                    <tr
                                      key={role}
                                      className={
                                        index <
                                        Object.keys(pagePermissions).length - 1
                                          ? "border-b"
                                          : ""
                                      }
                                    >
                                      ...
                                      {[
                                        ...
                                        <td key={page} className="p-2">
                                          <Select
                                            value={
                                              pagePermissions[
                                                role as keyof typeof pagePermissions
                                              ][
                                                page as keyof (typeof pagePermissions)[typeof role]
                                              ]
                                            }
                                            onValueChange={(value) =>

...
export async function registerUser(req: Request, res: Response) {
  try {
    const { firstName, lastName, userName, employeeId, email, role, password } = req.body;
    ...
    const department = role === "admin" ? "Management" :
                      role === "developer" ? "Development" :
                      role === "production-support" ? "Production" :
                      role === "uat-support" ? "Testing" :
                      role === "manager" ? "Management" : "Unknown";
